...
5. **w3resource C++ Exercises：补语法熟练度**

   官网：[w3resource C++ Exercises](https://www.w3resource.com/cpp-exercises/)

   适合用途：

   - 快速补语法题。
   - 练输入输出、条件、循环、数组、函数、类基础。
...
##### 2.index 指针套路：用下标记录“当前目标进度”


##### 3.单调栈

**常用于解决**：
- 找某个元素右边==第一个==元素比它大/小的元素
- 找某个元素左边==第一个==元素比它大/小的元素
- 计算等待天数、跨度、区间边界
...
```
其中：
- `stack<int> st` 是用于存储位于原来数组的==下标==，下标顺序可以是原容器==单调递增/递减==的顺序
